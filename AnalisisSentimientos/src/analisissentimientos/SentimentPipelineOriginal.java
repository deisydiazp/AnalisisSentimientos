 ...
 * @author John Bauer
 */
public class SentimentPipelineOriginal {
  ...
  private SentimentPipelineOriginal() {} // static methods
  ...
  public static void main(String[] args) throws IOException {
    ...
    filename = "C:\\prueba\\tweets\\pruebatexto.txt";
    ...
    if (filename != null) {
      ...
      for (Annotation annotation : annotations) {
        ...
        for (CoreMap sentence : annotation.get(CoreAnnotations.SentencesAnnotation.class)) {
          ...
          String valor=sentence.get(SentimentCoreAnnotations.SentimentClass.class);
